...
smooth = .001
FILE_LH = "../../Data/i09-75663.nxs"
FILE_LV = "../../Data/i09-75664.nxs"
...
def getBackground(energies, spectrum):
    ...
    try:
        ...
        for e in energies:
            ...
            m = diff2/(math.exp((energies[points[4]]-e)/B)+1)
            step.append(n+m)
    fitspect = [s - step[n]+step[n] for n, s in enumerate(spectrum)]
...
##    plt.plot(LVEnergies, LHNorm)
    ...
    title = plt.title("Mn L XLD spectrum of in-situ STO|LMO(2)")
