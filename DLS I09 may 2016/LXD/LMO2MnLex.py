...
smooth = .0003
FILE_LH = "../../Data/i09-75021.nxs"
FILE_LV = "../../Data/i09-75022.nxs"
...
def getBackground(energies, spectrum):
    ...
    last = len(energies)
    print 'LAST: ',last
    points = [1, 180, 280, 430, 520, 630, 905]
    B = 1
    answ = "n"
...
##    # Post-edge intensity fix
##    fact = LHSpectrum_norm[-5]/LVSpectrum_norm[-5]
##    LVSpectrum_norm = [s*fact for s in LVSpectrum_norm]
...
##    plt.plot(LVEnergies, LHNorm)
    ...
    plt.plot(energies, XLD, label='XLD x 4, LH - LV')
    
    legend = plt.legend(loc='upper right', shadow=True)
    title = plt.title("Mn L XLD spectrum of ex-situ STO|LMO(2)")
