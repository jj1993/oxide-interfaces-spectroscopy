...
smooth = .001
FILE_LH = "../../Data/i09-75513.nxs"
FILE_LV = "../../Data/i09-75514.nxs"
...
##        print points
    ...
    bg = range(points[0],points[1]) + range(points[5],points[6])
...
##    plt.plot(LHEnergies, LHNorm)
    ...
    title = plt.title("Mn L XLD spectrum of in-situ STO|LMO(7)")
