...
XLD2in = "csv/LMO2MnLin-3.csv"
XLD2ex = "csv/LMO2MnLex-3.csv"
XLD4in = "csv/LMO4MnLin-3.csv"
XLD7in = "csv/LMO7MnLin-3.csv"
XLD10ex = "csv/LMO10MnLex-3.csv"
...
if __name__ == '__main__':
    ...
    engy_10ex, spect_10ex = load(XLD10ex)
    ...
    plt.plot(engy_10ex, spect_10ex, '--', label="XLD for ex-situ $STO|LMO_{10}$")
