...
smooth = .0003
FILE_LH = "../../Data/i09-75023.nxs"
FILE_LV = "../../Data/i09-75024.nxs"
FILE_LH2 = "../../Data/i09-75045.nxs"
...
if __name__ == '__main__':
    ...
    with h5py.File(FILE_LH, 'r') as f:
        ...
        spectrum = f["/entry1/default/smpmiamp39"]
        i_0 = f["/entry1/default/sm5iamp8"]
    ...
    with h5py.File(FILE_LH2, 'r') as f:
        energies = f["/entry1/default/pgmenergy"]
        
        spectrum = f["/entry1/default/smpmiamp39"]
        i_0 = f["/entry1/default/sm5iamp8"]

        LH2Energies = [e for e in energies[2:-2]]
        LH2Spectrum = [s/i_0[n] for n, s in enumerate(spectrum[2:-2])]
    ...
    print "============"
    points = [1, 230, 380, 500, 580, 850, 1095]
    LHNorm, LH2Spectrum_norm = getBackground(LH2Energies, LH2Spectrum, points)
    splineRep = interpolate.splrep(LH2Energies, LH2Spectrum_norm, s=smooth)
    LH2Spectrum_norm = interpolate.splev(energies, splineRep, der=0)
    print "============"
    print "First background"
    print "============"
    points = [1, 180, 230, 300, 340, 458, 606]
...
##    plt.plot(LVEnergies, LHNorm)
    ...
    plt.plot(energies, LH2Spectrum_norm, label='LH optimised intensity')
    plt.plot(energies, LVSpectrum_norm, label='LV')
    plt.plot(energies, XLD, label='XLD x4, LH - LV')
    
    legend = plt.legend(loc='upper right', shadow=True)
    title = plt.title("Ti L XLD spectrum of ex-situ STO|LMO(2)")
