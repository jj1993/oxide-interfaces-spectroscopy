...
smooth = .0003
FILE_LC = "../../Data/i09-75706.nxs"
FILE_LCflip = "../../Data/i09-75720.nxs"
FILE_RC = "../../Data/i09-75707.nxs"
FILE_RCflip = "../../Data/i09-75721.nxs"
...
##    plt.plot(RCEnergies, RCflipSpectrum_norm, 'k:', label='$\sigma^-H^-$')
    plt.plot(energies, XMCD, linewidth=1.5, label='$\sigma^+-\sigma^-$ x4 in $H^+$')
    plt.plot(energies, XMCDflip,linewidth=1.5,  label='$\sigma^+-\sigma^-$ x4 in $H^-$')
    
    legend = plt.legend(loc='upper right', shadow=True, fontsize=16)
##    title = plt.title("Ti L XMCD spectrum of ex-situ STO|LMO(4)")
