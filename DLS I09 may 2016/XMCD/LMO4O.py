...
smooth = .0003
FILE_LC = "../../Data/i09-75708.nxs"
FILE_LCflip = "../../Data/i09-75722.nxs"
FILE_RC = "../../Data/i09-75709.nxs"
FILE_RCflip = "../../Data/i09-75723.nxs"
...
##    m_o, m_o_err, m_s, m_s_err = getMagnetism(RCSpectrum_norm, LCSpectrum_norm, energies, reg)
    ...
    # Save data to CSV
    spectra = [LCSpectrum_norm, LCflipSpectrum_norm, RCSpectrum_norm, RCflipSpectrum_norm, XMCD, MAG]
...
##    plt.plot(RCEnergies, RCflipSpectrum_norm, 'k:', label='$\sigma^-H^-$')
    plt.plot(energies, XMCD, 'k--', label='$\sigma^+-\sigma^-$ x4 in $H^+$')
    plt.plot(energies, MAG, '-', label='$H^+ - H^-$ x4 in $\sigma^+$')
##    plt.plot(energies, MAGflip, '-', label='$H^+ - H^-$ x4 in $\sigma^-$')
    
    legend = plt.legend(loc='upper right', shadow=True)
    title = plt.title("O K XMCD spectrum of ex-situ STO|LMO(4)")
