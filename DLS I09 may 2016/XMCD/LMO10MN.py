...
smooth = .0003
FILE_LCflip = "../../Data/i09-75376.nxs"
FILE_LC = "../../Data/i09-75386.nxs"
FILE_RCflip = "../../Data/i09-75377.nxs"
FILE_RC = "../../Data/i09-75387.nxs"
delta_E = 0.005 #eV, absolute
...
##        print points
    ...
    reg = [energies[points[1]], energies[points[3]], energies[points[5]]]
...
if __name__ == '__main__':
    ...
    # Get magnetism
    m_o, m_o_err, m_s, m_s_err = getMagnetism(LCSpectrum_norm, RCSpectrum_norm, energies, reg)

    # Make XMCD
    XMCD = [(LCSpectrum_norm[n]-s)/max(LCSpectrum_norm) for n, s in enumerate(RCSpectrum_norm)]      
    XMCDflip = [(LCflipSpectrum_norm[n]-s)/max(LCflipSpectrum_norm) for n, s in enumerate(RCflipSpectrum_norm)]

    # Save data to CSV
    spectra = [LCSpectrum_norm, LCflipSpectrum_norm, RCSpectrum_norm, RCflipSpectrum_norm, XMCD]
...
##    title = plt.title("Mn L XMCD spectrum of ex-situ STO|LMO(10)")
