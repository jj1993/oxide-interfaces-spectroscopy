...
smooth = .0003
FILE_LC = "../../Data/i09-75704.nxs"
FILE_LCflip = "../../Data/i09-75718.nxs"
FILE_RC = "../../Data/i09-75705.nxs"
FILE_RCflip = "../../Data/i09-75719.nxs"
...
##    plt.plot(RCEnergies, RCflipSpectrum_norm, 'k:', label='$\sigma^-H^-$')
    plt.plot(energies, XMCD, label='$\sigma^+-\sigma^-$ x4 in $H^+$', linewidth=2.0)
